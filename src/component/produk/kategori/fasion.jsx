...
class Fasion extends Component{
  render() {
  return (
      <div>
        <div>
                    ...
                    <div className="tt-collapse open">
                      ...
                      <div className="tt-collapse-content">
                        <div className="tt-aside">
                          ...
                          <a className="tt-item" href="product.html">
                            <div className="tt-img">
                              <span className="tt-img-default"><img src="images/produkk/bajuL3.jpg" data-src="images/produkk/bajuL3.jpg" alt="" /></span>
                              <span className="tt-img-roll-over"><img src="images/produkk/bajuL3.jpg" data-src="images/produkk/bajuL3.jpg" alt="" /></span>
                            </div>
                            <div className="tt-content">
                              <h6 className="tt-title">Flared Shift Dress</h6>
                              <div className="tt-price">
                        ...
                        <div className="col-6 col-md-4 tt-col-item">
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="product.html">
                                <span className="tt-img"><img src="images/produkk/bajuL3.jpg" data-src="images/produkk/bajuL3.jpg" alt="" /></span>
                                <span className="tt-img-roll-over"><img src="images/produkk/bajuL3.jpg" data-src="images/produkk/bajuL3.jpg" alt="" /></span>
                              </a>
                            </div>
                        ...
                        <div className="col-6 col-md-4 tt-col-item">
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left" />
                              <a href="product.html">
                                <span className="tt-img"><img src="images/produkk/bajuL4.jpg" data-src="images/produkk/bajuL4.jpg" alt="" /></span>
                                <span className="tt-img-roll-over"><img src="images/produkk/bajuL4.jpg" data-src="images/produkk/bajuL4.jpg" alt="" /></span>
                              </a>
                            </div>
                            <div className="tt-description">
                              <div className="tt-row">
                        ...
                        <div className="col-6 col-md-4 tt-col-item">
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left" />
                              <a href="product.html">
                                <span className="tt-img"><img src="images/produkk/bajuL1.jpg" data-src="images/produkk/bajuL1.jpg" alt="" /></span>
                                <span className="tt-img-roll-over"><img src="images/produkk/bajuL1.jpg" data-src="images/produkk/bajuL1.jpg" alt="" /></span>
                              </a>
                        ...
                        <div className="col-6 col-md-4 tt-col-item">
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left" />
                              <a href="product.html">
                                <span className="tt-img"><img src="images/produkk/bajuw1.jpg" data-src="images/produkk/bajuw1.jpg" alt="" /></span>
                                <span className="tt-img-roll-over"><img src="images/produkk/bajuw1.jpg" data-src="images/produkk/bajuw1.jpg" alt="" /></span>
                              </a>
                            </div>
                            <div className="tt-description">
                              <div className="tt-row">
                        ...
                        <div className="col-6 col-md-4 tt-col-item">
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left" />
                              <a href="product.html">
                                <span className="tt-img"><img src="images/produkk/bajuW2.jpg" data-src="images/produkk/bajuW2.jpg" alt="" /></span>
                                <span className="tt-img-roll-over"><img src="images/produkk/bajuW2.jpg" data-src="images/produkk/bajuW2.jpg" alt="" /></span>
                              </a>
                            </div>
                            <div className="tt-description">
                              <div className="tt-row">
                        ...
                        <div className="col-6 col-md-4 tt-col-item">
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left" />
                              <a href="product.html">
                                <span className="tt-img"><img src="images/produkk/bajuW4.jpg" data-src="images/produkk/bajuW4.jpg" alt="" /></span>
                                <span className="tt-img-roll-over"><img src="images/produkk/bajuW4.jpg" data-src="images/produkk/bajuW4.jpg" alt="" /></span>
                              </a>
                            </div>
                            <div className="tt-description">
                              <div className="tt-row">
                        ...
                        <div className="col-6 col-md-4 tt-col-item">
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left" />
                              <a href="product.html">
                                <span className="tt-img"><img src="images/produkk/prod1.jpeg" data-src="images/produkk/prod1.jepg" alt="" /></span>
                          ...
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="product.html">
                                ...
                                <span className="tt-img-roll-over"><img src="images/produkk/prod2.jpg" data-src="images/produkk/prod2.jpg" alt="" /></span>
                              </a>
                            </div>
                            <div className="tt-description">
                              <div className="tt-row">
