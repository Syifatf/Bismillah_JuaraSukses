                        ...
                        <div className="col-6 col-md-4 tt-col-item">
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left" />
                              <a href="product.html">
                                <span className="tt-img"><img src="images/produkk/sepatu6.jpg" data-src="images/produkk/sepatu6.jpg" alt="" /></span>
                                <span className="tt-img-roll-over"><img src="images/produkk/sepatu6.jpg" data-src="images/produkk/sepatu6.jpg" alt="" /></span>
                              </a>
                            </div>
                            <div className="tt-description">
                              <div className="tt-row">
                        ...
                        <div className="col-6 col-md-4 tt-col-item">
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left" />
                              <a href="product.html">
                                <span className="tt-img"><img src="images/produkk/sepatu7.jpg" data-src="images/produkk/sepatu7.jpg" alt="" /></span>
                                <span className="tt-img-roll-over"><img src="images/produkk/sepatu7.jpg" data-src="images/produkk/sepatu7.jpg" alt="" /></span>
                              </a>
                            </div>
                            <div className="tt-description">
                              <div className="tt-row">
