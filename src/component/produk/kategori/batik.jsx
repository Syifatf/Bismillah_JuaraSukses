                        ...
                        <div className="col-6 col-md-4 tt-col-item">
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="product.html">
                                <span className="tt-img"><img src="images/produkk/batik6.jpg" data-src="images/produkk/batik6.jpg" alt="" /></span>
                                <span className="tt-img-roll-over"><img src="images/produkk/batik6.jpg" data-src="images/produkk/batik6.jpg" alt="" /></span>
                              </a>
                            </div>
                        ...
                        <div className="col-6 col-md-4 tt-col-item">
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left" />
                              <a href="product.html">
                                <span className="tt-img"><img src="images/produkk/batik7.jpg" data-src="images/produkk/batik7.jpg" alt="" /></span>
                                <span className="tt-img-roll-over"><img src="images/produkk/batik7.jpg" data-src="images/produkk/batik7.jpg" alt="" /></span>
                              </a>
                            </div>
                            <div className="tt-description">
                              <div className="tt-row">
                        ...
                        <div className="col-6 col-md-4 tt-col-item">
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left" />
                              <a href="product.html">
                                <span className="tt-img"><img src="images/produkk/batik9.jpg" data-src="images/produkk/batik9.jpg" alt="" /></span>
                                <span className="tt-img-roll-over"><img src="images/produkk/batik9.jpg" data-src="images/produkk/batik9.jpg" alt="" /></span>
                              </a>
                        ...
                        <div className="col-6 col-md-4 tt-col-item">
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left" />
                              <a href="product.html">
                                <span className="tt-img"><img src="images/produkk/batikk3.jpg" data-src="images/produkk/batikk3.jpg" alt="" /></span>
                                <span className="tt-img-roll-over"><img src="images/produkk/batikk3.jpg" data-src="images/produkk/batikk3.jpg" alt="" /></span>
                              </a>
                              <div className="tt-countdown_box">
                                <div className="tt-countdown_inner">
                                  <div className="tt-countdown" data-date="2018-12-08" data-year="Yrs" data-month="Mths" data-week="Wk" data-day="Day" data-hour="Hrs" data-minute="Min" data-second="Sec" />
                        ...
                        <div className="col-6 col-md-4 tt-col-item">
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left" />
                              <a href="product.html">
                                <span className="tt-img"><img src="images/produkk/batikk2.jpeg" data-src="mages/produkk/batikk2.jpeg" alt="" /></span>
                                <span className="tt-img-roll-over"><img src="mages/produkk/batikk2.jpeg" data-src="mages/produkk/batikk2.jpeg" alt="" /></span>
                              </a>
                            </div>
                            <div className="tt-description">
                              <div className="tt-row">
                        ...
                        <div className="col-6 col-md-4 tt-col-item">
                          <div className="tt-product thumbprod-center">
                            <div className="tt-image-box">
                              ...
                              <a href="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left" />
                              <a href="product.html">
                                <span className="tt-img"><img src="images/produkk/batikk1.jpg" data-src="images/produkk/batikk1.jpg" alt="" /></span>
                                <span className="tt-img-roll-over"><img src="images/produkk/batikk1.jpg" data-src="images/produkk/batikk1.jpg" alt="" /></span>
                              </a>
                            </div>
                            <div className="tt-description">
                              <div className="tt-row">
